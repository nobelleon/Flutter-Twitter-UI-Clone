...
class NotificationsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        body: ListView.builder(itemCount: 1, itemBuilder: _buildAll));
  }
  ...
  final List<User> whoFollowedMe = [
    User(name: "Dangote", avatarUrl: "assets/image/dangote.jpeg"),
    User(name: "Bill Gates", avatarUrl: "assets/image/billgates.jpg"),
    User(name: "Rihanna", avatarUrl: "assets/image/rihanna.jpg")
  ];
  ...
  final List<User> highlights = [
    ...
    User(name: "Bill Gates", avatarUrl: "assets/image/billgates.jpg"),
    User(name: "Rihanna", avatarUrl: "assets/image/rihanna.jpg"),
    User(name: "Dangote", avatarUrl: "assets/image/bigsean2.jpg"),
    User(name: "Bill Gates", avatarUrl: "assets/image/wizkid.jpg"),
    User(name: "Rihanna", avatarUrl: "assets/image/davido2.jpg")
  ];
  ...
  final List<User> likesRecentPic = [
    User(
        name: "Rihanna",
        avatarUrl: "assets/image/rihanna.jpg",
        likedTweet:
            "Today is awesome, I am very happy and thank God for everything"),
    User(name: "Dangote", avatarUrl: "assets/image/dangote.jpeg"),
    User(name: "Bill Gates", avatarUrl: "assets/image/billgates.jpg"),
  ];
          ...
          children: <Widget>[
            ...
            new Column(
              ...
              children: <Widget>[
                ...
                new Text(whoFollowedMe[0].name +
                    " and " +
                    (whoFollowedMe.length - 1).toString() +
                    " others followed you"),
              ],
            ),
          ],
              ...
              children: <Widget>[
                ...
                new RichText(
                  text: new TextSpan(
                    ...
                    children: <TextSpan>[
                      new TextSpan(
                          text: likesRecentPic[0].name +
                              " and " +
                              likesRecentPic[1].name,
