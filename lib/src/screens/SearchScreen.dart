...
import 'package:twitter_ui/src/beranda.dart';
      ...
      slivers: <Widget>[
        ...
        new SliverList(
          delegate: new SliverChildBuilderDelegate(
              (context, index) => _buildTrendsList(context, index),
        ...
        new SliverAppBar(
          ...
          title: new ListTile(
            ...
            subtitle: new Text(
              "Because you follow Diddy and 11 others",
        ...
        new SliverList(
          delegate: new SliverChildBuilderDelegate(
              (context, index) => Beranda().buildTweet(context, index),
              childCount: Beranda().allTweets.length),
        ),
        // _buildTrends(),
        //_buildTweets()
      ],
